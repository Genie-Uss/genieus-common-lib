...
import com.genieus.common.internal.request.UseStockRequest;
...
public interface PromotionInternalClient {
    ...
    @PostMapping("/internal/v1/promotions/stock-usage")
    PromotionClientResponse useStock(@RequestBody UseStockRequest useStockRequest);
}
